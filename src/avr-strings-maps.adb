...
package body AVR.Strings.Maps is
...
--     is
--        --  Result : AVR_String (0 .. Map'Length - 1);
--        Result : AVR_String (0 .. 255);
--        J      : Unsigned_8;
...
--      From_Len : constant Unsigned_8 := From'Length;
--      To_Len   : constant Unsigned_8 := To'Length;
...
--        Max_Ranges : Character_Ranges (1 .. Unsigned_8 (Set'Length) / 2 + 1);
--        Range_Num  : Unsigned_8;
--        C          : Character;
...
--     is
--        Result : AVR_String (1 .. Character'Pos (Character'Last) + 1);
--        Count  : Unsigned_8 := 0;
