...
--                                                                          --
--                  A V R . R E A L _ T I M E . D E L A Y S                 --
--                                                                          --
--                                  S p e c                                 --
--                                                                          --
...
--  This package implements AVR.Real_Time.Time delays

--  Note: the compiler generates direct calls to this interface, in
--  the processing of time types.

package AVR.Real_Time.Delays is
...
private
   ...
   pragma Export (Ada, Delay_Until, "ada__calendar__delays__delay_until");
